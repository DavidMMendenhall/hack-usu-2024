...
/**
 * Rotates a 4x4 matrix, represetned as an array in coloum major order, by the specified ammount in place.
...
/**
 * Rotates a 4x4 matrix, represented as an array in column major order, by the specified ammount in place.
 * @param {number[] | Float32Array} matrix
 * @param {number} radians
 */
...
/**
 * Translates a 4x4 matrix represented as an array in column mojor order in place
 * @param {number[] | Float32Array} matrix 
 * @param {number} x 
 * @param {number} y 
 * @param {number} z 
...
/**
 * Scales a 4x4 matrix represented as an array in column mojor order in place
 * @param {number[] | Float32Array} matrix 
 * @param {number} x 
 * @param {number} y 
 * @param {number} z 
...
let getIdenity4x4Matricies = (count) => {
...
export {lookAt, getIdenity4x4Matricies,scaleMatrix4x4, scalarMultiplyMatrix4x4, translate, copyMatrix4x4, multiplyMatrix4x4, transposeMatrix4x4, identityMatrix4x4, inverseMatrix4x4, rotateX, rotateY, rotateZ}